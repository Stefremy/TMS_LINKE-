              ...
              <div className="w-2/3 flex flex-col gap-4">
                <div className="bg-white p-5 rounded-lg border border-slate-200 shadow-sm">
                  ...
                  <div className="mt-2 mb-4 p-3 bg-slate-50 border border-slate-200 rounded-lg flex items-center justify-between">
                    <div>
                      <div className="text-xs font-bold text-slate-700">Verificação de Comunicação SOAP</div>
                      <div className="text-[11px] text-slate-500">Valida se o endpoint CTT responde aos envelopes XML da sua conta.</div>
                    </div>
                    <button
                      type="button"
